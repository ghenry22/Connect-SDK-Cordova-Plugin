...
if (!isMac) {
	...
	var paths = {
		...
		"GoogleCastSDK_URL": "https://developers.google.com/cast/downloads/GoogleCastSDK-Public-3.0.0-Release-ios.zip",
		"GoogleCast_Framework": "./csdk_tmp/GoogleCastSDK-Public-3.0.0-Release/GoogleCast.framework"
	};
